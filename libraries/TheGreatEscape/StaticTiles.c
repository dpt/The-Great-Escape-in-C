...
const static_tile_t static_tiles[79] =
{
  ...
  { { { 0xE0, 0xE0, 0x60, 0x60, 0xC0, 0xC0, 0x80, 0x00 } }, attribute_YELLOW_OVER_BLACK },
  { { { 0x10, 0x08, 0x04, 0x02, 0x02, 0x01, 0x01, 0x00 } }, attribute_YELLOW_OVER_BLACK },
  { { { 0x81, 0xFF, 0xE7, 0xDB, 0xDB, 0xFF, 0x81, 0xFF } }, attribute_GREEN_OVER_BLACK },
  { { { 0x00, 0x38, 0x44, 0xCA, 0xD2, 0xE2, 0x7C, 0x38 } }, attribute_BRIGHT_WHITE_OVER_BLACK },
};
